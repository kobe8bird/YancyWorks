...
<div class="card card-custom">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                ...
                <!--begin::Dropdown-->
                     @include("admin.employees.partials.export")
                <!--end::Dropdown-->
        ...
        var table = $('#kt_datatable');
                ...
                table.DataTable({
                    ...
                    ajax: {
                        ...
                        url: "{{ route('admin.employee.listings') }}",
                        type: 'POST',
                        data: {
                            // parameters for custom backend script
                            columnsDef: [
                                'firstname', 'lastname', 'email', 'phone', 'company', 'created_at', 'updated_at', 'Actions'],
                        },
                    },
                    columns: [
                        {data: 'firstname'},
                    ...
                    columnDefs: [
                        {
                            ...
                            render: function(data, type, full, meta) {
                                var id = full.id;
                                var showUrl = '{{ route('admin.employee.show', ":id") }}';
                                var editUrl = '{{ route('admin.employee.edit', ":id") }}';
                                var deleteUrl = '{{ route('admin.employee.destroy', ":id") }}';
	                        ...
	                        <a href="javascript:;" data-url="'+deleteUrl+'" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon delete-record" title="Delete">\
								<span class="svg-icon svg-icon-md">\
									<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
										<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
											<rect x="0" y="0" width="24" height="24"/>\
